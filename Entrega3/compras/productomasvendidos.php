<?php
  ...
  $id_tienda = $_POST['id_tienda_producto_vendidos'];
  $nombre = $_POST['rec_producto_vendido'];
    ...
    <div id="content-wrapper" class="d-flex flex-column">
		...
		<div id="content">
			...
			<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
			  ...
			  <h1 class="h3 mb-4 text-gray-800">Búsqueda producto: <?php echo($nombre); ?></h1>
			...
			<div class="container-fluid">
				<form id="update_persona" name="update_persona" method="POST" action="newcompra.php" data-toggle="validator">
					<div class="table-responsive">
						...
						<tbody>
							<?php
								$result = mysqli_query($con, "SELECT * FROM Productos WHERE id_tienda = ".$id_tienda." and upper(nombre) like '".$nombre."%' order by nombre ");
								while ($row1 = mysqli_fetch_assoc($result)){ 
									echo "<tr>";
									echo "<td>" . $row1["nombre"] . "</td>";	
									echo "<td>" . $row1["precio"] . "</td>";
									echo "<td>" . $row1["descripcion"] . "</td>";
									echo "<td>" . $row1["tipo_producto"] . "</td>";
									echo "</tr>";	
								}
							?>
						</tbody>						
