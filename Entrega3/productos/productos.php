...
<head>
  ...
  <title>Mi Tienda - Mantenedor de Productos</title>
...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <h1 class="h3 mb-4 text-gray-800">Mantenedor de Productos</h1>
        ...
        <div class="container-fluid">
          <div class="table-responsive">			
            <table id="table_producto" id="table_producto" class="table table-bordered table-hover" width="98%">
  ...
  <form id="ActionUpdate" name="ActionUpdate" action="productos_detalle.php" method="POST">
  ...
  <script>
    ...
    $('#table_producto tfoot th').each(function () {
        var title = $(this).text();
			  if (title != ''){
